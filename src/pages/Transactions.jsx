  ...
  return (
    <div className="max-w-4xl mx-auto">
                    ...
                    return (
                      <div key={parent.id}>
                        <div className={`flex items-center gap-2 px-3 py-2.5 hover:bg-gray-50 ${isSelected ? 'bg-blue-50' : ''}`}>
                          {subs.length > 0 ? (
                            <button onClick={() => toggleExpand(parent.id)} className="text-gray-400 hover:text-gray-600 w-4 text-xs flex-shrink-0">
                              {isExpanded ? '▼' : '▶'}
                            </button>
                          ) : (
                          ...
                          <button
                            ...
                            className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 ${
                              ...
                              : isPartial ? 'bg-blue-200 border-blue-400'
                          ...
                          return (
                            <div key={sub.id} className={`flex items-center gap-2 px-3 py-2 pl-14 hover:bg-gray-50 ${isSubSelected ? 'bg-blue-50' : ''}`}>
                              <button
                                ...
                                className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 ${
                                  isSubSelected ? 'bg-blue-600 border-blue-600' : 'border-gray-300 hover:border-blue-400'
                                }`}
                              >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        {!loading && filtered.length === 0 && (
          <div className="px-5 py-8 text-center text-gray-400">No transactions found.</div>
        )}
